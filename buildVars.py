...
Configure your Gemini API key and target language in NVDA Preferences."""),
	...
	# Author(s)
	"addon_author": "Polyglot-LLM Contributors",
	# URL for the add-on documentation support
	"addon_url": "https://github.com/Aarushb/polyglot-LLM",
	# URL for the add-on repository where the source code can be found
	"addon_sourceURL": "https://github.com/Aarushb/polyglot-LLM",
...
# You can either list sourceFiles= as follows, or do it from the sconstruct file (See below)
# pythonSources = [os.path.join("addon", "globalPlugins", "polyglotLLM", "*.py")]

# Files that contain strings for translation. Usually your python sources
i18nSources = pythonSources = ["addon/globalPlugins/polyglotLLM/*.py"]
...
# e.g. markdown.extensions.tables for a table builder extension.
markdownExtensions = []
